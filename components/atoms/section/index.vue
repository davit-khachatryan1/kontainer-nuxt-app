<template>
  <div
    :class="[
      ...
      ...[sectionPaddingTop ? 'padding-top-' + sectionPaddingTop : ''],
      ...[sectionPaddingBottom ? 'padding-bottom-' + sectionPaddingBottom : ''],
    ]"
  >
    <PinElement
...
export default {
  ...
  props: {
    angleType: {
      validator(value) {
        return (
          [SECTION_ANGLE_NONE, SECTION_ANGLE_POSITIVE, SECTION_ANGLE_NEGATIVE].indexOf(
            value
          ) !== -1
        );
      },
    ...
    padding: {
      validator(value) {
        return (
          [SECTION_PADDING_DEFAULT, SECTION_PADDING_BOTTOM_NONE].indexOf(value) !== -1
        );
      },
