            ...
            <div class="span-container">
              ...
              <div class="footer__top__linklists span8 span12--tablet span4--mobile">
                <div class="span-container">
                  <LinkList
                    v-if="footerMenus"
                    :name="footerMenus[1].title"
                    :links="footerMenus[1].links"
                    class="span2 span3--tablet span2--mobile"
                  />
                  <LinkList
                    v-if="footerMenus"
                    :name="footerMenus[2].title"
                    :links="footerMenus[2].links"
                    class="span2 span3--tablet span2--mobile"
                  />
                  <div class="footer__top__linklists__mobile-break"></div>
                  <LinkList
                    v-if="footerMenus"
                    :name="footerMenus[3].title"
                    :links="footerMenus[3].links"
                    class="span2 span3--tablet span2--mobile"
                  />
                  <LinkList
                    v-if="footerMenus"
                    :name="footerMenus[4].title"
                    :links="footerMenus[4].links"
                    class="span2 span3--tablet span2--mobile"
                  />
                </div>
              </div>
        ...
        <div class="footer__bottom">
          <div class="footer__content">
            <div class="footer__bottom__badges">
              <a
                href="https://www.g2.com/products/kontainer/"
                title="Write a review of Kontainer on G2"
                target="_blank"
              >
                <G2Badge />
              </a>
              <a
                href="https://www.capterra.com/reviews/143730/Kontainer?utm_source=vendor&utm_medium=badge&utm_campaign=capterra_reviews_badge"
                target="_blank"
              >
                <CapterraBadge />
              </a>
...
import { SECTION_PADDING_BOTTOM_NONE } from "~/components/composables/section";
...
export default {
  ...
  computed: {
      ...
      if (
        ...
        return {
          1: {
            ...
            links: prepareWPObjectsToLinks(store.pageOptions.column1_links),
          },
          2: {
            title: store.pageOptions.column2_title,
            links: prepareWPObjectsToLinks(store.pageOptions.column2_links),
          },
          3: {
            title: store.pageOptions.column3_title,
            links: prepareWPObjectsToLinks(store.pageOptions.column3_links),
          },
          4: {
            title: store.pageOptions.column4_title,
            links: prepareWPObjectsToLinks(store.pageOptions.column4_links),
          },
        };
      }
    ...
    legalLinks() {
      const store = useStore();
      if (
        store.pageOptions.legalLinks &&
        Object.keys(store.pageOptions.legalLinks).length
      ) {
