      ...
      <div class="span-container">
        ...
        <div class="span6 span6--tablet span4--mobile">
          <Teaser
            hero
            :data="data.hero_left"
            :class="['teaser--large', 'hero__right']"
            @openVideoModal="openVideoModal"
          >
            <slot>
              <div class="media-container">
                <div class="hero-video" v-if="videoUrl || video_url">
                  <smart-image
                    class="hero-video__placeholder force-dynamic-height"
                    :image="data.hero_right.fallback_image"
                    :srcset="
                      srcSetPaths
                        ? [
                            data.hero_right.fallback_image.url + ' 1025w',
                            data.hero_right.fallback_image.sizes.tablet + ' 1024w',
                            data.hero_right.fallback_image.sizes.tablet_sm + ' 950w',
                            data.hero_right.fallback_image.sizes.mobile + ' 768w',
                            data.hero_right.fallback_image.sizes.mobile_sm + ' 567w',
                            data.hero_right.fallback_image.sizes.mobile_min + ' 320w',
                          ]
                        : []
                    "
                    :sizes="
...
const LaptopMockupShadow = defineAsyncComponent(() =>
  import("~/assets/svg/hero-laptop-shadow.svg")
);
