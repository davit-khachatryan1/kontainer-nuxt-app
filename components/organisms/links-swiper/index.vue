  ...
  <section class="link-swiper">
    <div class="content-grid-container">
      ...
      <div
        v-if="
          data.show_view_all &&
          data.link_view_all_wrapper &&
          data.link_view_all_wrapper.link_view_all
        "
        class="link-swiper__actions"
      >
        <ButtonComponent
          :link="data.link_view_all_wrapper.link_view_all"
          :type="'outline'"
          >{{ langString("_view_all", "View all") }}</ButtonComponent
        >
      </div>
    </div>
  </section>
...
const KardComponent = defineAsyncComponent(() =>
  import("~/components/molecules/kard-inverted/index.vue")
);
