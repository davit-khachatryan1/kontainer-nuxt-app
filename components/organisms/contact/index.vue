  ...
  <section class="contact-section">
    <div class="content-grid-container">
      <div class="span-container">
        <div
          v-if="sellingpointsVisible"
          class="span6 span6--tablet span4--mobile sellingpoints"
        >
          <h2 v-if="data.signup_left.heading">{{ data.signup_left.heading }}</h2>
          <SellingpointComponent
            v-for="(sellingpoint, index) in data.signup_left.sellingpoints"
            :key="index"
        ...
        <div
          :class="[
            sellingpointsVisible
              ? 'span6 span6--tablet span4--mobile'
              : 'span12 span12--tablet span12--mobile',
          ]"
        >
          <div class="form-container" :class="{ 'form-container--sent': isSent }">
            <template v-if="data.signup_right.content_type === 'html'">
              ...
              />
              <div
                class="form-container__text"
                v-if="data.signup_right.text"
                v-html="data.signup_right.text"
              ></div>
              <VForm>
                <slot>
                  <InputComponent
                  ...
                  />
                  <InputSelect
                    v-if="data.signup_right.wrapper.options_repeater.length"
                    name="topic"
              ...
              <div
                class="contact-section__info"
                v-if="data.signup_right.info"
...
const InputComponent = defineAsyncComponent(() =>
  import("~/components/atoms/input/index.vue")
);
const SellingpointComponent = defineAsyncComponent(() =>
  import("~/components/molecules/sellingpoint/index.vue")
);
const Textarea = defineAsyncComponent(() =>
  import("~/components/atoms/textarea/index.vue")
);
...
export default {
  ...
  data() {
    return {
      sellingpointsVisible:
        this.data.signup_left.heading || this.data.signup_left.sellingpoints,
      contact: {
        name: "",
        email: "",
        subjects: [
  ...
  mounted() {
    if (this.data.signup_right.wrapper.options_repeater) {
      for (
        let i = 0;
        i < this.data.signup_right.wrapper.options_repeater.length;
        i += 1
      ) {
        const newOption = {
...
.form-container {
  ...
  ::v-deep {
    ...
    .form-container__feedback {
      ...
      .form-container-fade-enter,
      .form-container-fade-leave-to {
        opacity: 0;
      }
    }
  }
